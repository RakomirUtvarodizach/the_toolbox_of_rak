...
class _ShoppingListEditorViewState extends State<ShoppingListEditorView>
  ...
  @override
  void initState() {
    _localListItems = TestingData().getShoppingListItems();
  ...
  Widget build(BuildContext context) {
    debugPrint(
        '\nAll for first elelemnt\n\tType-> ${_liveEditingOfListItems[0]['type']},\n\tPriority-> ${_liveEditingOfListItems[0]['priority']},\n\tTitle-> ${_liveEditingOfListItems[0]['title_controller'].text},\n\tDescription-> ${_liveEditingOfListItems[0]['description_controller'].text}');
                      ...
                      children: <Widget>[
                        ...
                        Align(
                          child: DropdownButton(
                            ...
                            value: _liveEditingOfListItems[index]['priority'],
                            onChanged: (newValue) {
                              setState(() {
